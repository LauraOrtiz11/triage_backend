...
namespace triage_backend.Repositories
{
    ...
    ";
            ...
            command.Parameters.AddWithValue("@ID_MEDICO", (object?)idMedico ?? DBNull.Value);
            command.Parameters.AddWithValue("@ID_PRIORIDAD", idPrioridad);
            ...
            command.Parameters.AddWithValue("@ID_ENFERMERO", idEnfermero);
